    ...
    return (
        <>
            <div className="page-header">
                <h1>Reports</h1>
                <p>Clinical reports and summaries</p>
            </div>
            ...
            <div className="card">
                <div className="card-header">
                    <div className="card-header-left">
                        ...
                        <div>
                            <div className="card-title">Clinical Reports</div>
                            <div className="card-subtitle">Generated summaries and notes</div>
                        </div>
                    </div>
                ...
                <div className="card-body">
                    <div style={{ textAlign: "center", padding: "48px 0", color: "var(--d-text-muted)" }}>
                        ...
                        <p style={{ fontSize: "0.95rem", fontWeight: 500 }}>No reports generated</p>
                        <p style={{ fontSize: "0.82rem", marginTop: 6 }}>Reports will appear here after consultations</p>
                    </div>
                </div>
            </div>
        </>
